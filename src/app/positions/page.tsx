...
export const metadata: Metadata = { title: "Positions des partis", description: "La matrice complète : chaque parti, chaque question, chaque source." };

export default function Donnees() {
  return (
    <div className="space-y-6">
      <h1 className="text-h1">Positions des partis</h1>
